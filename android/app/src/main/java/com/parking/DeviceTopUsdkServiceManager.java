...
public class DeviceTopUsdkServiceManager {
    ...
    private AidlSystem aidlSystem = null;
    ...
    public static void getmDeviceServiceManager() {
        synchronized (DeviceTopUsdkServiceManager.class) {
            ...
            mDeviceServiceManager.mContext = MainApplication.getApp();
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            try {
                aidlSystem = AidlSystem.Stub.asInterface(mDeviceService.getSystemService());
    ...
    public AidlCameraScanCode getCameraManager() {
        ...
        AidlCameraScanCode aidlCameraScanCode = AidlCameraScanCode.Stub.asInterface(getCamera());

        return aidlCameraScanCode;
    }
    ...
    public IBinder getCamera() {
        try {
            if (mDeviceService != null) {
                return mDeviceService.getCameraManager();
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    public AidlBuzzer getBuzzerManager() {

        AidlBuzzer aidlBuzzer = AidlBuzzer.Stub.asInterface(getBuzzer());
    ...
    public IBinder getEMVL2() {
        try {
            if (mDeviceService != null) {
                return mDeviceService.getL2Emv();
            }
        } catch (RemoteException e) {
            e.printStackTrace();
        }
...
//    }
    ...
    public void lockButtons() {
        try {
            aidlSystem.enableHomeButton(true);
            aidlSystem.enableRecentAppButton(true);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void unlockButtons() {
        try {
            aidlSystem.enableHomeButton(false);
            aidlSystem.enableRecentAppButton(false);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
